...
class OffensiveAgent(ReflexCaptureAgent):
    ...
    def getFeatures(self, gameState, action):
        ...
        # numAgents = self.getTeam(gameState)
        # #print(numAgents)

        # # agent1 = numAgents[0].getAgentState(self.index)
        # # agent2 = numAgents[1].getAgentState(self.index)

        # agent1 = numAgents[0]
        # agent2 = numAgents[1]

        # #print(gameState.getAgentPosition(agent1))
        # AgentDist = self.getMazeDistance(gameState.getAgentPosition(agent1), gameState.getAgentPosition(agent2))
        # #print(AgentDist)
...
class DefensiveReflexAgent(ReflexCaptureAgent):
    ...
    def getFeatures(self, gameState, action):
        ...
        if len(invaders) > 0 and not myState.isScared() and len(self.getFood(successor).asList()) < len(self.getFoodYouAreDefending(successor).asList()):
            ...
            #print(gameState.getAgentPosition(agent1))
            AgentDistTwo = self.getMazeDistance(gameState.getAgentPosition(agent1), gameState.getAgentPosition(agent2))
            #print(AgentDist)
